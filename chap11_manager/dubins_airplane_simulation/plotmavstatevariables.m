...
% modified 12/11/2009 - RB
    ...
    hdot_c      = uu(27);     % commanded climbrate
...
%    bz_hat      = uu(49);            % estimated z-gyro bias
  ...
  % first time function is called, initialize plot and persistent vars
    if t==0,
        ...
        subplot(8,2,11)
        hold on
        chi_handle = graph_y_yhat_yd(t, hdot, 0, hdot_c, 'hdot', []);
        
        subplot(8,2,12)
        hold on
        r_handle = graph_y_yhat_yd(t, r, r_hat, 0, 'r', []);
    ...
    % at every other time step, redraw state variables
       ...
       graph_y_yhat_yd(t, hdot, 0, hdot_c, 'hdot', chi_handle);
       graph_y_yhat_yd(t, p, p_hat, p_c, 'p', p_handle);
       graph_y_yhat_yd(t, q, q_hat, q_c, 'q', q_handle);
       graph_y_yhat_yd(t, r, r_hat, 0, 'r', r_handle);
